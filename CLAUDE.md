# agent-reviewer — Architecture & Conventions
...
> _Replace this paragraph with one or two sentences describing what `agent-reviewer` does and who it serves. Keep it concrete — the agents read this first._
